...
<body>
    ...
    <g:form controller="photoTemplate" action="match" class="camera-test form-horizontal">
        <div class="row text-center">
            <div class="col-xs-5">
                <button type="button" name="capture" data-target="#photo1" class="btn btn-default" data-action="${createLink(controller: 'PhotoTemplate', action: 'capture')}">Capturar</button>
                <input type="text" name="photo" data-target="#photo1" value="1" />
                <img style="width: 480px;" id="photo1" data-id="1" src="/photo/resource/1" />
            </div>
            <div class="col-xs-5">
                <button type="button" name="capture" data-target="#photo2" class="btn btn-default" data-action="${createLink(controller: 'PhotoTemplate', action: 'capture')}">Capturar</button>
